...
Retextures the attached image using a hyperrealistic high gloss render style. Applies high-gloss translucent rubber material with iridescent coating for a unique surface texture. Enhances the image with studio HDRI lighting, vibrant colors, and special effects like glow and chromatic aberration.
