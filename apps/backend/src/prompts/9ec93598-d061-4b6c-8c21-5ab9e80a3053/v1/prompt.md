...
MOST IMPORTANT!: Provide your output as a structured list using dependency grammar principles, with main objectives as root nodes and sub-objectives as dependent nodes. Use indentation to show hierarchical relationships.


## How to use the prompt

Converts user input into a structured list of grant proposal objectives. Ensures objectives align with the funding organization's mission and priorities. Applies SMART criteria and dependency grammar to organize objectives hierarchically.
