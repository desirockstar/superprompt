...
slug: "promptscreate-meeting-summary"
---
...
Converts user input into a structured summary of meeting notes, focusing on key points, decisions, and action items. Ensures the summary is concise, clear, and provides a comprehensive overview for someone who did not attend the meeting. Follows a specific format that includes an overview, discussion points, decisions, action items, deadlines, unresolved issues, and a conclusion.
