...
slug: "create-a-workflow-mapping-of-operations"
...
slug: "promptscreate-a-workflow-mapping-of-operations"
---
...
Converts user input into a structured workflow mapping to optimize productivity and efficiency. Focuses on analyzing current processes, identifying key steps, and recommending improvements. Outputs the workflow in a clear, concise table format with specified columns for process steps, responsible parties, tools, and metrics.
