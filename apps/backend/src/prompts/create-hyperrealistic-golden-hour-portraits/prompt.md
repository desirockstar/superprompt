---
title: "create hyperrealistic golden hour portraits"
slug: "create-hyperrealistic-golden-hour-portraits"
...
slug: "promptscreate-hyperrealistic-golden-hour-portraits"
---

{
  ...
  "water_and_texture": {
    "skin_covering": "Skin covered in [SKIN ELEMENT] running down naturally",
  ...
  "lighting_setup": {
    ...
    "effect": "Soft yet intense glow on the [SKIN ELEMENT] on the [SUBJECT]'s face, precisely highlights micro-details"
  },
  "hair_details": {
...
Generates a hyper-realistic AI image of a close-up portrait with wet skin during golden hour lighting. Captures extreme detail on facial features like pores, freckles, and water droplets using shallow depth of field. Creates cinematic golden tones with professional camera simulation focusing on one eye with perfect sharpness.
