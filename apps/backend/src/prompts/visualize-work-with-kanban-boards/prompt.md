...
slug: "visualize-work-with-kanban-boards"
...
slug: "promptsvisualize-work-with-kanban-boards"
---
...
Converts user input into a structured Kanban board format with designated columns for Backlog, In Progress, Testing, and Completed. Provides detailed instructions on how to populate and manage each column, including task prioritization, setting work-in-progress limits, and task movement strategies. Offers guidance on using the Kanban board to enhance workflow efficiency and achieve productivity goals.
