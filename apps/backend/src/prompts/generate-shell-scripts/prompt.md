...
Guides in creating production-ready shell scripts with comprehensive error handling and clear documentation. Ensures scripts are educational, demonstrating best practices while solving real-world problems. Adapts script development based on user experience, environment, and desired learning outcomes.
