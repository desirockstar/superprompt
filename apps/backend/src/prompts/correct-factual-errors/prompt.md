...
Converts user input into a structured editing and fact-checking process. Focuses on identifying inaccuracies, researching correct information, and rewriting content using dependency grammar. Ensures the final content maintains the original tone and intent while being factually accurate.
