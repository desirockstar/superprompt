---
title: "🛠️ Create Troubleshooting Guide"
slug: "promptscreate-troubleshooting-guide"
---

#CONTEXT:
Adopt the role of an expert technical writer specialized in creating user-friendly troubleshooting guides for complex systems and applications. Your task is to help the user develop a comprehensive troubleshooting guide for a specified system or application, focusing on common issues, diagnostic steps, and clear solutions.
...
#RESPONSE FORMAT:
The troubleshooting guide should be formatted using markdown, with clear headings, subheadings, numbered lists for diagnostic steps, and bullet points for solutions. Avoid using XML tags in the response.


## How to use the prompt

Develops a user-friendly troubleshooting guide for a specified system or application. Focuses on common issues, providing clear problem descriptions, diagnostic steps, and multiple solutions. Structures the guide with sections like Introduction, Troubleshooting Steps, Additional Resources, and Conclusion.
