...
slug: "promptsrework-stalled-projects"
---
...
Analyzes a stalled project by identifying the team's current mental framework and hidden assumptions that block progress. Creates alternative viewpoints to challenge existing beliefs and finds conflicts between different ways of seeing the project. Delivers a new way to define the project problem with specific actions the team can take in the next 10 days to restart momentum.
