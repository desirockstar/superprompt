...
Analyzes an AI prompt that creates chat response templates for handling product outages and service disruptions. Generates a crisis communication playbook with pre-written messages for different outage phases and scenarios. Provides clear guidelines for honest customer communication during technical problems without using complex jargon.
