...
slug: "learn-new-skills-regularly"
...
slug: "promptslearn-new-skills-regularly"
---
...
Converts user input into a detailed, personalized learning plan. Focuses on aligning the learning activities with the user's career goals and current skill level. Structures the output in a markdown table format, categorizing learning resources, time commitments, and expected outcomes.
