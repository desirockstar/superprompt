...
slug: "promptsbuild-recipe-finders"
---
...
Creates a web-based recipe finder that connects to a food API and displays recipes with search filters. Builds interactive features like meal planning, recipe saving, user reviews, and adjustable serving sizes. Adds practical cooking tools including timers, offline access, and social sharing options.
