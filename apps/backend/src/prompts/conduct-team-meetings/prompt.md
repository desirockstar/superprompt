---
title: "conduct team meetings"
slug: "conduct-team-meetings"
...
slug: "promptsconduct-team-meetings"
---
...
Structures the meeting by creating an agenda that outlines objectives, topics, and expected outcomes using the dependency grammar framework. Facilitates the meeting to encourage active participation, manage discussions, and document key decisions and action items. Produces comprehensive meeting minutes that reflect the structure and outcomes of the meeting, emphasizing the connections between topics and decisions using the dependency grammar framework.
