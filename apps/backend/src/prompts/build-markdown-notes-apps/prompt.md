...
slug: "build-markdown-notes-apps"
...
slug: "promptsbuild-markdown-notes-apps"
---
...
Analyzes the AI prompt to identify the main task it requests the AI to complete. Breaks down what the AI prompt instructs into three key points that explain its purpose. Delivers a simple explanation of what happens when this AI prompt gets used as input.
