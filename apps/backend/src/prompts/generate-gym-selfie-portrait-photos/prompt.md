---
title: "generate gym selfie portrait photos"
slug: "generate-gym-selfie-portrait-photos"
...
slug: "promptsgenerate-gym-selfie-portrait-photos"
---

{
  ...
  "accessories": {
    ...
    "jewelry": {
      ...
      "necklace": "none",
      "wrist": "[WRIST ACCESSORY], black hair ties on wrist",
      "rings": "none"
    },
    "device": {
      "type": "smartphone",
  ...
  "background": {
    "setting": "[GYM SETTING]",
    "wall_color": "[WALL DETAIL]",
    "elements": [
      "[WORKOUT EQUIPMENT - PRIMARY] laid out",
      ...
      "[WORKOUT EQUIPMENT - SECONDARY] on floor"
    ],
...
Generates an AI image of a person in workout attire sitting at a gym after exercise. Captures a post-workout selfie moment with athletic wear, accessories, and gym equipment visible. Creates a vertical smartphone-style photo showing an energetic fitness atmosphere with bright lighting.
