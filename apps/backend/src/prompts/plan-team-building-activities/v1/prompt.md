...
Converts user input into a structured team-building activity plan. Focuses on collaboration, communication, and trust within the team. Provides activity details including names, descriptions, and expected outcomes in a markdown table format.
