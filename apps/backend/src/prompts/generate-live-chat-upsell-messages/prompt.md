...
slug: "generate-live-chat-upsell-messages"
...
slug: "promptsgenerate-live-chat-upsell-messages"
---
...
- [Continue for all critical "never sell" scenarios]

## How to use the prompt

Creates natural chat messages that help agents suggest upgrades and add-ons during support conversations. Provides two versions of each AI prompt response for different agent comfort levels with sales language. Delivers a playbook organized by customer moments with guidelines on when to avoid selling.
