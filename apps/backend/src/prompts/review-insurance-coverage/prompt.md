...
slug: "review-insurance-coverage"
...
MOST IMPORTANT!: Present your output in a markdown table format with columns for Risk Category, Current Coverage, and Recommended Actions. Provide a brief summary of key findings and priorities before the table.


## How to use the prompt

Analyzes and identifies potential risks and coverage gaps for a specified business type. Creates a detailed risk management analysis including a table with risk categories, current coverage, and recommended actions. Provides a summary of key findings and priorities tailored to the business's specific needs and constraints.
