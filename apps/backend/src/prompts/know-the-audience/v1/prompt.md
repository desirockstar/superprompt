...
Analyzes the target audience's demographics, interests, and expectations to tailor the speech content. Adapts the speech's language, content, and delivery style to align with the audience's preferences and needs. Structures the speech using dependency grammar to ensure clarity and logical flow of ideas.
