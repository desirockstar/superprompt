...
slug: "evaluate-projects-with-rice-scoring-model"
...
slug: "promptsevaluate-projects-with-rice-scoring-model"
---
...
Evaluates potential projects using the RICE scoring model to prioritize tasks based on Reach, Impact, Confidence, and Effort. Provides a structured format for presenting the evaluation results in a markdown table, including calculated RICE scores. Offers clear explanations for each project's scores to aid decision-makers in understanding the value and resource requirements.
