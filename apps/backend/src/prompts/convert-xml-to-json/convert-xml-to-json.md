...
slug: "promptsconvert-xml-to-json"
---
...
Analyzes XML payload structures to identify patterns, namespaces, and attribute handling requirements. Designs conversion rules to map XML elements to JSON keys, ensuring proper array detection and namespace management. Generates transformation code with error handling and validation to produce clean, readable JSON output.
