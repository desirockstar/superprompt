...
slug: "optimize-skill-learning-resources"
...
slug: "promptsoptimize-skill-learning-resources"
---
...
Provides a detailed overview of the skill and its relevance to the user's specified tasks. Recommends a structured list of courses (beginner, intermediate, advanced) tailored to the user's skill level and task requirements. Suggests additional learning resources like books, articles, and tutorials to complement the courses.
