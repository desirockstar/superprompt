...
slug: "manage-documents-with-document-management-systems"
...
slug: "promptsmanage-documents-with-document-management-systems"
---
...
Converts user input into a structured document management system (DMS) design plan. Outlines key components, workflow, security measures, collaboration features, and search mechanisms of the DMS. Utilizes dependency grammar framework for clear and structured documentation and standard operating procedures.
