...
slug: "optimize-build-configurations"
...
Analyzes current build configurations and project structure to identify performance bottlenecks and missing optimizations. Provides actionable optimization strategies to reduce bundle sizes and build times using advanced webpack techniques. Recommends environment-specific build configurations with detailed plugin setups, loader optimizations, and bundling strategies.
