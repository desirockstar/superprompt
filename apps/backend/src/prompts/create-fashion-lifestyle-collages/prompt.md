---
title: "create fashion lifestyle collages"
slug: "create-fashion-lifestyle-collages"
...
slug: "promptscreate-fashion-lifestyle-collages"
---

{
  "scene_description": "A cohesive 4-panel fashion lifestyle collage featuring the same [SUBJECT] in a trendy [STYLE AESTHETIC] outfit, showcasing different dynamic poses and angles.",
  "subject": {
  ...
  "style": {
    ...
    "aesthetic": "[STYLE AESTHETIC], Urban, Gen Z, Candid",
...
Generates a 4-panel AI image collage showing the same person in different urban poses and angles. Creates street fashion photography featuring customizable outfits and brand products in a city setting. Produces high-resolution lifestyle shots with consistent character across all four frames in a 2x2 grid layout.
