...
slug: "apply-the-eisenhower-matrix-to-tasks"
...
slug: "promptsapply-the-eisenhower-matrix-to-tasks"
---
...
Categorizes tasks based on urgency and importance using the Eisenhower Matrix. Structures the tasks into four quadrants: Do First, Schedule, Delegate, Don't Do. Provides justifications for each task's placement within the matrix.
