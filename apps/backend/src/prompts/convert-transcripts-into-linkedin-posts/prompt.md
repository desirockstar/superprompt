---
title: "convert transcripts into linkedin posts"
slug: "convert-transcripts-into-linkedin-posts"
...
slug: "promptsconvert-transcripts-into-linkedin-posts"
---
...
Converts the provided transcript into LinkedIn posts. Follows the specified "Hook-Contrarian-In Reality-Advice-Wrap" framework for each post. Ensures each post adheres to the tone, language, and character limit as outlined.

## How to use the prompt

Analyze the transcript for key themes and insights that align with your industry or expertise. Craft each LinkedIn post by selecting a unique insight or controversial point from the transcript to use as the "Hook". Ensure each "Contrarian" section effectively challenges a common industry misconception, using evidence or perspectives from the transcript to support your argument.
