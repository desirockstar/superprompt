...
Converts user input into a structured set of instructions for developing Key Performance Indicators (KPIs). Ensures the KPIs are aligned with business performance metrics and strategic goals. Incorporates source citations for each KPI to validate and support the data used.
