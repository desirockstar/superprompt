...
slug: "prepare-letters-of-support"
...
MOST IMPORTANT!: Provide your output in a structured format with clear headings for each section of the letter (e.g., Introduction, Proposal Overview, Endorsement, Conclusion).


## How to use the prompt

Converts user input into a structured format for crafting letters of support for grant proposals. Focuses on highlighting the proposal's merits, potential impact, and endorsements in a clear and persuasive manner. Ensures each letter is tailored to reflect the specific endorser's perspective and relationship to the proposal.
