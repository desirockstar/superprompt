...
slug: "promptscreate-project-management-outline"
---
...
Assists users in breaking down complex projects into a structured, hierarchical outline. Focuses on creating a clear and logical sequence of phases, tasks, and subtasks. Ensures each component of the project is actionable and comprehensively covers all major aspects.
