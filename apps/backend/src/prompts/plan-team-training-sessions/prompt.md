---
title: "plan team training sessions"
slug: "plan-team-training-sessions"
...
slug: "promptsplan-team-training-sessions"
---
...
MOST IMPORTANT!: Your output must always be in a markdown table format with 4 columns for Session Title, Date, Time, and Key Objectives to structure the training plan.


## How to use the prompt

Converts user input into a structured training plan. Focuses on defining session titles, dates, times, and key objectives. Ensures the plan addresses the specified number of sessions, duration, and areas for improvement.
