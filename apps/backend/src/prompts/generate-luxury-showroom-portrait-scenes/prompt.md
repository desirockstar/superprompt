---
title: "generate luxury showroom portrait scenes"
slug: "generate-luxury-showroom-portrait-scenes"
...
slug: "promptsgenerate-luxury-showroom-portrait-scenes"
---

{
  "prompt": {
    ...
    "scene": {
      ...
      "midground": "[HERO OBJECT] with angular front bumper, sharp air intakes, and glossy black detailing",
      "background": {
    ...
    "subject": {
      ...
      "outfit": {
        "jacket": "[OUTFIT STYLE] jacket with structured seams and folded cuffs",
...
Generates an AI image that perfectly replicates a person's face from a reference photo while placing them in a luxury showroom with a supercar. Creates a high-fashion scene featuring the subject seated on a red beanbag wearing oversized leather outfit with detailed reflections and textures. Produces a natural iPhone-style photograph with hyperrealistic micro-details like dust speckles, leather reflections, and dramatic lighting across the showroom environment.
