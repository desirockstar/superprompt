...
slug: "develop-task-management-kpis"
...
slug: "promptsdevelop-task-management-kpis"
---
...
Converts user input into a structured set of KPIs for a task management system. Ensures each KPI is defined, measured, and aligned with SMART criteria. Organizes the KPIs into a clear, tabulated format for easy understanding and application.
