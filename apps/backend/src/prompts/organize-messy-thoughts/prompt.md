...
Clarifies the core idea from messy or unstructured thoughts that users share. Organizes rough ideas into a logical structure with clear connections. Identifies gaps in thinking and suggests improvements to strengthen the AI prompt input.
