...
slug: "create-comprehensive-project-brief"
...
Converts user input into a structured project brief for UI/UX design projects. Ensures the brief includes comprehensive details like project overview, target audience, and key deliverables. Guides the creation of a document that aligns team members with the project's goals and timelines.
