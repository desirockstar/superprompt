...
slug: "craft-empathetic-response-templates"
...
slug: "promptscraft-empathetic-response-templates"
---

##PHASE 1: Analyzing Common Scenarios
...
Guides through a customer service template creation process with scenario analysis and simulation development phases. Gathers common issue types, emotional triggers, company policies, and complaint examples through empathy mapping and discovery. Delivers empathetic response templates with variations, role-play training simulations, and implementation metrics for support teams.
