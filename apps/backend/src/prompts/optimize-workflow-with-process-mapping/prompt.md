...
slug: "optimize-workflow-with-process-mapping"
...
slug: "promptsoptimize-workflow-with-process-mapping"
---
...
Analyzes the current workflow process to identify inefficiencies such as bottlenecks and redundancies. Develops an optimized workflow process that addresses identified inefficiencies to enhance productivity. Presents the analysis and recommendations in a structured markdown table format, detailing the current process, identified inefficiencies, and optimized process.
