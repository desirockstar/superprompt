...
slug: "resolve-customer-complaints"
...
Guides through a structured complaint resolution workflow with diagnostic and response phases. Collects the customer complaint text and analyzes emotional tone, core issues, and context. Delivers a complete resolution package with issue analysis, strategy recommendations, and a ready-to-send empathetic customer response.
