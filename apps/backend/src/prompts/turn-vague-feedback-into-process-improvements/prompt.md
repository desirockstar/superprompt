...
slug: "turn-vague-feedback-into-process-improvements"
...
slug: "promptsturn-vague-feedback-into-process-improvements"
---
...
Translates vague team feedback into specific workplace problems that can be fixed. Identifies the real process gaps that cause complaints like "communication is broken" or "leadership doesn't listen." Creates a step-by-step plan with small, practical changes that address the root causes behind team frustrations.
