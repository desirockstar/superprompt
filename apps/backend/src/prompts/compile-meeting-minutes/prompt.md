...
Converts user input into a structured format for documenting meeting minutes. Organizes information into categories: attendees, agenda items, discussion points, decisions, and action items. Ensures detailed and accurate representation of the meeting's proceedings in a table format.
