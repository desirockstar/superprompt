...
slug: "promptsprioritize-your-tasks"
---
...
Ranks user's tasks based on their importance to the specified business goal, assigning a numerical importance score to each. Identifies tasks that can be eliminated due to their low impact on achieving the business goal. Provides strategies for automating or delegating remaining tasks to optimize productivity and focus.
