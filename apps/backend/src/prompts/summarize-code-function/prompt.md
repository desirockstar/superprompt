...
slug: "promptssummarize-code-function"
---
...
Analyzes a given code block to distill its core purpose into a single, clear sentence. Applies the Single Responsibility Principle to identify the primary action or transformation performed by the code. Strips away technical details to focus on the core business logic or system behavior.
