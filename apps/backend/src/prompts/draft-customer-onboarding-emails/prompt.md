...
slug: "draft-customer-onboarding-emails"
...
slug: "promptsdraft-customer-onboarding-emails"
---
...
Creates a warm welcome email that new customers receive right after they sign up Confirms what the customer now has access to and gives one clear action to take next Uses a friendly and personal tone that makes the customer feel supported and ready to start
