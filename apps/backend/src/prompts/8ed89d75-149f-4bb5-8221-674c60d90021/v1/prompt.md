...
Generates an AI image of a hand holding a smartphone with a custom screen display replacing the original content. Applies realistic lighting effects and perspective warping to make the uploaded image fit naturally on the phone screen. Creates a studio-quality product shot with proper reflections, shadows, and photorealistic details for commercial use.
