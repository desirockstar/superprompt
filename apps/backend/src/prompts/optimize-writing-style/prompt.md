...
Converts user input into a structured task for rewriting text. Ensures the rewritten text adheres to specific stylistic guidelines to enhance readability and engagement. Focuses on varying sentence length to create a rhythmic and engaging prose.
