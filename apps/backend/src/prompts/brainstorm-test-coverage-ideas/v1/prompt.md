...
Identifies critical business logic that drives revenue and user experience, focusing on meaningful behavior validation. Analyzes risky areas including external dependencies, complex algorithms, and state management to uncover potential vulnerabilities. Examines boundary conditions, error handling paths, and integration scenarios to ensure comprehensive test coverage.
