---
title: "🥀 Generate Candid Group Dining Scenes"
slug: "promptsgenerate-candid-group-dining-scenes"
---
  ...
  "prompt": {
    ...
    "subjects": [
...

      {
        ...
        "description": "[glamorous woman with bold, confident presence]",
...

      {
        ...
        "description": "[striking woman with editorial model energy]",
...
Generates a hyper-realistic AI image of a stylish group gathered around a white dining table in an upscale venue. Captures each person's distinct fashion, expressions, and gestures from a high-angle perspective with dramatic lighting. Creates a candid, editorial-style scene with warm ambient light contrasting against dark wood paneling and gold lettering.
