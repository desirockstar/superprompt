...
slug: "conduct-brainwriting-sessions"
...
slug: "promptsconduct-brainwriting-sessions"
---
...
Explains the brainwriting process to the team, emphasizing sequential individual ideation and collaborative discussion. Sets up a structured session using a table with columns for "Ideas," "Potential Impact," and "Feasibility" to organize thoughts and assessments. Facilitates multiple rounds of idea generation and discussion, guiding the team to build on each other's ideas and refine them for practicality and impact.
