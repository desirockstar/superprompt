...
slug: "develop-regression-test-lists"
...
---
title: "🛡️ Develop Regression Test Lists"
source: godofprompt.ai
slug: "promptsdevelop-regression-test-lists"
---
...
Identifies high-risk regression areas in application architecture, focusing on core business logic, payment processing, and user authentication. Categorizes tests by priority, execution time, and risk level to optimize test coverage under time constraints. Provides guidance on test environment setup, data requirements, and dependencies to prevent execution blocks.
