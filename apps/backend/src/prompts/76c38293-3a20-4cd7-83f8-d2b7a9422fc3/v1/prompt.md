...
Converts user input into a structured sales strategy in a table format. Analyzes business type, customer profile, sales goals, challenges, and budget to tailor the strategy. Focuses on scalability, measurability, and alignment with industry best practices.
