---
title: "🫧 Generate Douyin Flash Selfie Portraits"
source: godofprompt.ai
slug: "promptsgenerate-douyin-flash-selfie-portraits"
---

{
  "intent": "Generate a hyper-idealized, 'Douyin-aesthetic' portrait of [SUBJECT] at night, utilizing direct flash photography to create a high-contrast, ethereal look with clear weather conditions.",
  "frame": {
    "aspect_ratio": "9:16",
  ...
  "subject": {
    "identity": "[SUBJECT] with hyper-symmetrical, doll-like features characterized by the 'bunny tongue' and 'puppy eye' aesthetic.",
    ...
    "mouth": "Heart-shaped lips featuring a 'gradient lip' technique. The center of the lips is a saturated, glossy [LIP SHADE], fading outward to a blurred, pale nude at the vermilion border. The texture is soft and hydrated.",
    "hair": "[HAIR DESCRIPTION], catching the flash with a subtle sheen.",
...
Generates a hyper-idealized AI image portrait using flash photography that creates a flat, ethereal look popular in social media aesthetics. Produces an extreme close-up selfie with doll-like features, porcelain skin, and gradient lips against a dark urban night background. Simulates smartphone camera settings with wide-angle lens effects that emphasize large eyes and delicate features in high contrast lighting.
