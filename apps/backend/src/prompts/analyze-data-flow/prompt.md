...
Traces the flow of data through code systems, mapping every transformation from input to output. Identifies entry points, processing steps, decision points, and storage operations in data flow. Provides a comprehensive narrative explaining data dependencies and potential bottlenecks.
