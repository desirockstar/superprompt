---
title: "📜 Write Freelance Contracts"
source: godofprompt.ai
slug: "promptswrite-freelance-contracts"
---
...
Converts user input into a structured freelance contract template focusing on scope of work, payment terms, intellectual property rights, and termination clauses. Ensures the contract is tailored to the specific needs of the freelancer based on their profession, project duration, payment structure, intellectual property considerations, and location. Provides a clear, concise, and legally binding contract template that protects both the freelancer and the client.
