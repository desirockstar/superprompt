...
slug: "promptsgenerate-fashion-portrait-transformations"
---
...
Generates a full-body AI image that preserves the subject's original facial features and body shape from a reference photo. Creates a fashion portrait with customizable clothing style and accessories in a minimalist studio setting. Uses sculptural lighting to highlight the subject's pose and garment details while maintaining an ethereal mood.
