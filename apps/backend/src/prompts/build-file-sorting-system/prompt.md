---
title: "build file sorting system"
slug: "build-file-sorting-system"
...
Analyzes the user's chaotic file system to identify disorganization patterns. Maps the desired organizational structure to GTD principles, creating a sustainable order. Designs intelligent sorting rules and scripts that adapt to user behavior and maintain file integrity.
