...
Converts user input into a structured Crisis Management Plan. Identifies potential crisis scenarios, outlines preventive measures, details response strategies, and establishes recovery procedures. Focuses on communication protocols, resource allocation, and post-crisis evaluation.
