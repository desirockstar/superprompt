---
title: "capture chalkboard anime artworks"
slug: "capture-chalkboard-anime-artworks"
...
---
title: "🌬️ Capture Chalkboard Anime Artworks"
source: godofprompt.ai
slug: "promptscapture-chalkboard-anime-artworks"
---

{
  ...
  "subject": {
    "primary_subject": "A large-scale, intricate chalk drawing of [CHARACTER] on a standard green classroom blackboard.",
    "visual_details": "[CHARACTER DESCRIPTION]",
    ...
    "surrounding_elements": "To the right of the character, vertical Japanese text reading '[BOARD TEXT]' is written in crisp white chalk."
  },
  "environment": {
  ...
  "lighting": {
    ...
    "color_temperature": "Neutral white, approximately 5000K, ensuring accurate color rendition of the chalks against the dark green board.",
  ...
  "negative": {
    "content": "Multiple characters, digital art overlay, vector graphics, paper texture, oil painting, messy composition, extreme low angle, fisheye lens.",
...
Generates a photorealistic AI image of chalk art on a classroom blackboard featuring a single anime character. Captures the textured, dusty quality of chalk with visible strokes and smudges in a documentary style. Places the artwork in a Japanese classroom setting with a teacher's desk and chalk supplies in the foreground.
