...
slug: "create-weekly-schedule-template"
...
slug: "promptscreate-weekly-schedule-template"
---
...
Designs a weekly task schedule template with time blocks for various work activities. Utilizes color-coding and symbols to differentiate task types in the schedule. Ensures the schedule is balanced and flexible, incorporating breaks and personal time.
