...
slug: "test-business-plan-assumptions"
...
Identifies hidden assumptions in a business plan that lack proof or evidence. Rates each assumption based on how strong the supporting evidence is. Creates tests to check if risky assumptions are true before money is spent.
