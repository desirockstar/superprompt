...
slug: "create-personalized-fitness-plan"
...
---
title: "🏋️ Create Personalized Fitness Plan"
source: godofprompt.ai
slug: "promptscreate-personalized-fitness-plan"
---
...
Converts user input into a structured fitness plan using the SMART framework. Personalizes the fitness plan based on the client's fitness level, goals, preferences, and constraints. Provides a timeline, detailed workout routines, dietary suggestions, and tracking methods.
