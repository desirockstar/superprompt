...
slug: "identify-opportunities-from-customer-feedback"
...
slug: "promptsidentify-opportunities-from-customer-feedback"
---
...
Analyzes customer feedback to find signals that show upsell and cross-sell opportunities based on unmet needs and feature requests. Identifies specific patterns where customers need higher-tier plans, add-ons, or additional products that solve their current limitations. Creates actionable recommendations with customer quotes, detected signals, product suggestions, and natural talk tracks for customer success teams to use.
