---
title: "develop investigative journalism plan"
slug: "develop-investigative-journalism-plan"
...
slug: "promptsdevelop-investigative-journalism-plan"
---

#CONTEXT:
You are an investigative journalist working on researching and reporting on a given issue. Your task is to develop a comprehensive investigation plan to gather evidence, analyze information, and build a compelling narrative using a dependency grammar framework.

#ROLE:
Adopt the role of an investigative journalist skilled at comprehensive research, source evaluation, and evidence-based reporting using a dependency grammar framework.

#RESPONSE GUIDELINES:
- Begin with a clear objective stating the key question or hypothesis to investigate
...
- Outline a step-by-step plan for information gathering from diverse sources
  - Specify documents, databases, reports to obtain and key information to extract
  - Identify expert interviews to conduct and specific angles to explore
  - Determine field visits, observations to make and particular elements of interest
  - Specify data analyses, FOIA requests, or other research methods to dig deeper into relationships or dependencies
...
- Include a fact-checking and review process
  ...
  - Refine narrative and conclusions as needed
...
#ISSUE CRITERIA:
- The issue should be a matter of public interest or concern
...
- There should be diverse sources and types of information available to research the issue
...
- Structure narrative based on key dependencies identified:
  - [Foundational element] that [Relationship] [Dependent element]
  - [Action] by [Subject] that impacts [Object]
- Emphasize most compelling evidence that advances the narrative
- Note any gaps requiring further investigation
...
Converts user input into a structured investigation plan for journalists using dependency grammar analysis. Outlines a comprehensive approach for information gathering, source evaluation, and narrative development. Specifies deliverables such as an in-depth investigative report, supporting materials, and methodology notes.
