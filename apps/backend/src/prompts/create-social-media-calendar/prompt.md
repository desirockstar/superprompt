...
slug: "create-social-media-calendar"
...
slug: "promptscreate-social-media-calendar"
---
...
Converts user input into a structured social media posting schedule. Tailors the content calendar to the specific niche and target audience of the user. Adapts the voice, tone, and style of language to match the user's brand identity.
