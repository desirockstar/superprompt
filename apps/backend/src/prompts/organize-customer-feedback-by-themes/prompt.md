...
slug: "organize-customer-feedback-by-themes"
...
Reads customer feedback and creates category tags based on themes that emerge from the data. Assigns each feedback entry a primary category, secondary category, and sentiment label. Generates a summary table showing categories, entry counts, and dominant sentiment for reporting.
