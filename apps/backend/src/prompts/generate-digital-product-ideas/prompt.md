---
title: "generate digital product ideas"
slug: "generate-digital-product-ideas"
...
slug: "promptsgenerate-digital-product-ideas"
---
...
Transforms the user input into actionable ideas for a digital product within a $100,000 budget. Creates a matrix table categorizing each idea by effort, scores, time, and costs. Ensures the response stays within a 2000 character limit.

## How to use the prompt

Identify Market Gaps: Before suggesting ideas, conduct thorough market research to identify gaps or needs that are not currently being met by existing digital products. Utilize Expertise: Involve stakeholders and experts in relevant fields to brainstorm and validate ideas, ensuring the suggestions are feasible and valuable. Focus on Scalability: Consider the potential for scaling each product idea when evaluating effort, scores, time, and costs to ensure long-term viability and profitability.
