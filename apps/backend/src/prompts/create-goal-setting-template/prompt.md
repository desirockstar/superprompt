...
slug: "create-goal-setting-template"
...
slug: "promptscreate-goal-setting-template"
---
...
Assists in creating a structured template to break down annual goals into quarterly, monthly, and weekly targets. Ensures each level of the goal-setting template aligns with overarching objectives and contributes to their achievement. Includes progress tracking and goal alignment features to monitor success and maintain focus.
