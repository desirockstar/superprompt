---
**Primary:** Productivity, Goal Setting  
**Output_Type:** Text  
**Output_Format:** Guide  
**Recommended_AI:** Claude, Gemini  
**Domain:** General  
...
**Audience:** General  
**Tone:** Professional  
**Tags:** "#cognitive-behavioral-techniques #goal-achievement #identity-change #habit-formation #self-improvement"  
**Revised_Title:** "Cognitive Behavioral Technique Framework for Goal Achievement and Identity Transformation"  
**Revised_Slug:** cognitive-behavioral-technique-framework-goal-achievement-identity-transformation  
...
Rubric:
  ...
  Diagnostics:
    Critical_Gap: "Context_Quality scored 8; the prompt could better account for users with different commitment levels."  
    Suggested_Fix: "Add an optional section for users to indicate their baseline discipline level for protocol customization."
---
...
Analyzes an AI prompt that builds a 30-day goal achievement system based on identity change and behavior design. Creates a personalized protocol that fixes internal beliefs first, then adds concrete daily actions. Delivers a complete roadmap with morning routines, decision filters, and weekly checks the user can start immediately.
