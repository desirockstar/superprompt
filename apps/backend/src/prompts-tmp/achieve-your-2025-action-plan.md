...
**Audience:** B2C  
**Tone:** Professional  
**Tags:** "#annual-action-plan #2025-roadmap #quarterly-plan #goal-setting #timeline"  
**Revised_Title:** "2025 Annual Action Plan: Quarterly Roadmap & Weekly Action Steps"  
**Revised_Slug:** 2025-annual-action-plan-quarterly-roadmap-weekly-action-steps  
...
Rubric:
	...
	Diagnostics:
		Critical_Gap: "Constraint_Management could be tighter; lacks explicit limits on weekly scope."  
		Suggested_Fix: "Add explicit limits for weekly action items and maximum weekly time commitments."  
---
...
Engages in a comprehensive Q&A to gather essential context about the user's 2025 vision. Crafts a detailed 12-month action plan broken down into quarterly goals, monthly targets, and weekly action steps. Ensures all goals are specific, measurable, action-oriented, and aligned with the 4% rule for realistic growth.
