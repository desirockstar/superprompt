...
**Output_Type:** Text  
**Output_Format:** Plan  
**Recommended_AI:** ChatGPT, Claude, Grok  
**Domain:** General  
...
**Audience:** General  
**Tone:** Educational  
**Tags:** "#action-planning #goal-achievement #habit-formation #productivity-tips #implementation-intentions"  
**Revised_Title:** "Achieve Clear Action Plans"
**Revised_Slug:** achieve-clear-action-plans  
...
Rubric:
  ...
  Diagnostics:
    Critical_Gap: "Completeness scored 6; duplicate sections in the prompt create redundancy without adding value."  
    Suggested_Fix: "Remove the duplicate CONTEXT, ROLE, and GOAL sections and consolidate into a single coherent structure."
---
...
Guides in creating a structured and actionable plan to achieve personal goals. Breaks down the goal into manageable tasks while emphasizing habit formation and consistency. Provides clear instructions and strategies for overcoming obstacles and optimizing the environment for success.
