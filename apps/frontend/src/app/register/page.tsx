...
export default function RegisterPage() {
  ...
  const { register, isLoading, isAuthenticated, authChecked, checkAuth } = useAuthStore();
  ...
  function handleLinkedinOAuth() {
    window.location.href = `${API_BASE}/auth/oauth/linkedin`;
  }

  function handleTwitterOAuth() {
    window.location.href = `${API_BASE}/auth/oauth/twitter`;
  }
